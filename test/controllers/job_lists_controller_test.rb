...
class JobListsControllerTest < ActionController::TestCase
  ...
  test "should create job_list" do
    assert_difference('JobList.count') do
      post :create, job_list: { description: @job_list.description, title: @job_list.title, user_id: @job_list.user_id }
    end
  ...
  test "should update job_list" do
    patch :update, id: @job_list, job_list: { description: @job_list.description, title: @job_list.title, user_id: @job_list.user_id }
    assert_redirected_to job_list_path(assigns(:job_list))
  end
